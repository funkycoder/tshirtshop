...
class ErrorHandler {
    ...
    public static function Handler($errNo, $errStr, $errFile, $errLine) {
         ...
         * ( they back trace to the 2 methods in this class)
        ...
        //Prepare the $error_message
        $error_message = '<div class="error_box"><pre>' . $error_message . '</pre></div>';
        if (($errNo == E_WARNING && !IS_WARNING_FATAL ) || ($errNo == E_NOTICE || $errNo == E_USER_NOTICE)) {
